...
/**
 * Compiles .proto files using protoc-jar embedded protoc compiler. Also supports pre-installed protoc binary,
 * and downloading binaries (protoc and protoc plugins) from maven repo
 * 
 * @goal run
