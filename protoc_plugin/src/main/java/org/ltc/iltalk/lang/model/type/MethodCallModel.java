...
import org.ltc.iltalk.lang.model.IRequest;
import org.ltc.iltalk.lang.model.IResponse;
...
public class MethodCallModel
        implements ExecutableTypeModel, IRequest, IResponse

    @Override
    public List<? extends TypeModelVariable> getTypeVariables() {
        return null;
    }
    ...
    @Override
    public List<? extends TypeModel> getParameterTypes() {
        return null;
    }

    @Override
    public TypeModel getReceiverType() {
        return null;
    }

    @Override
    public List<? extends TypeModel> getThrownTypes() {
        return null;
    }

    @Override
    public TypeModelKind getKind() {
        return tmKind;
    }
    ...
    public <R, P> R accept(TypeVisitor<R, P> v, P p) {
         ...
         * returned by cc reflection.  This method is intended for
        ...
        @Override
        public void send(TypeModel value) {

        }

        @Override
        public TypeModel receive() {
            return null;
        }

        private TypeModelKind tmKind;
}
...
////         */
////        List<? extends TypeModel> getThrownTypes();
////
////        /**
...
//     * method on the returned annotation
//     * will result in a {@link MirroredTypeException},
//     * from which the corresponding {@link TypeModel} may be extracted.
//     * Similarly, attempting to read a {@code Class[]}-valued element
//     * will result in a {@link MirroredTypesException}.
//     * <p>
//     * <blockquote>
...
//
///*
//package java.cc.protobuf.pbsdb.pro;
//
...
////        /**
////         * Returns the simple name of a constructor, method, or
////         * initializer.  For a constructor, the name {@code "<create>"} is
////         * returned, for a static initializer, the name {@code "<clinit>"}
////         * is returned, and for an anonymous class or instance
////         * initializer, an empty name is returned.
////         *
...
// * the returned annotation object can throw many of the exceptions
// * that can be thrown when calling methods on an annotation object
// * returned by org.ltc.iltalk.cc reflection.  This method is intended for
// * callers that are written to operate on a known, fixed set of
// * annotation types.
// * </blockquote>
// *
