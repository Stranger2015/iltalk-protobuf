 ...
 * <pre>{@code
 * public void traverseForward(ICharIterator iter) {
 *     for(char c = iter.first(); c != ICharIterator.DONE; c = iter.next()) {
 *         processChar(c);
 *     }
 * }
 * }</pre>
 ...
 * <pre>{@code
 * public void traverseBackward(ICharIterator iter) {
 *     for(char c = iter.last(); c != ICharIterator.DONE; c = iter.previous()) {
 *         processChar(c);
 *     }
 * }
 * }</pre>
 ...
 * <pre>{@code
 * public void traverseOut(ICharIterator iter, int pos) {
 *     for (char c = iter.setIndex(pos);
 *              c != ICharIterator.DONE && notBoundary(c);
 *              c = iter.next()) {
 *     }
...
public interface ICharIterator extends Cloneable, Iterator<Character>
{
    /**
