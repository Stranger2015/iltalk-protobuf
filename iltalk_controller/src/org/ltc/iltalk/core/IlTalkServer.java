...
public class ILTalkServer {
	...
	public static void main(String[] args) throws Exception {
        ...
        final RpcCallback<DuplexProtocol.Status> clientStatusCallback = new RpcCallback<PingPong.Status>() {
    ...
    public void connectionChanged(RpcClientChannel clientChannel) {
        ...
        DuplexProtocol. serverStatus = PingPong.Status.newBuilder()
        ...
        log.warn("org.ltc.iltalk.com.googlecode.protobuf.duplex.OobMessage send failed.", oobSend.cause());
        }
